...
- [STAGING] 2026-07-16 · Summer (via Requests form) · Batch of 5 CRM changes, worked 2026-07-17 one at a time: (1) Rural Hospital + all 81 industry values in every picker — DONE, also closed the 2026-07-08 IndustryCategory ~55-value gap by deriving all industry lists from one shared source; (2) Contact notes placement; (3) Partner-field restructure; (4) account merge/archive access; (5) "Active tab" clarification — statuses tracked per item below as they land.
