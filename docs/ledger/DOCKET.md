...
| A6 | Add "Security Monitoring" as a sellable product + process Summer's 7/31 sale | Summer (price ladder likely Joe) | CRM request 2026-08-03 (low): she sold "a Security Monitoring package for $100 on Friday" (2026-07-31) and needs the product in Pulse to book it. The SRA-bundle proposal doc (Desktop, 2026-07-16 DRAFT "not yet approved") prices Security Monitoring at **$400** for 1–20 FTE standalone, "incl." in CE/SP/BA-Pro bundles, and itself flags the >20-FTE standalone ladder as an unresolved open item — so $100 matches nothing on paper. Blocked on: (1) actual sale price / why $100, (2) which account + FTE band, (3) recurring-vs-one-time + term, (4) price grid to seed (flat $400? 1–20 only + manual above?). Build itself is small: seed migration on the BA-SRA/On-Site-Fee pattern (products + price_book_entries across all books × tiers; half-seeding shows $0 in picker). | `grep -rin 'security.monitoring' supabase/migrations/ src/` = 0 hits (product not yet added) | 2026-08-03 |
