...
| B23 | Reports polish round (Nathan 8/4 late, picked from the 28-idea menu) | IN PROGRESS. Build + verify (look/perf/usefulness) these, integrated: (1+27) favorites: star reports+lists, float to catalog top + landing, gold-star chip row in catalog if pretty; (2) save-as-list exit on standard PEOPLE reports, report by report, mind the constrained data path; (4) saved pulls: recent Pull-people queries, one-click rerun, do strategically; (7) paste-emails/CSV import to list with match preview, strategically placed in Lists; (9) KPI count-up animation; (10) content-shaped skeletons; (11) hover prefetch of lazy zones; (18) designed empty states w/ one line + action; (19) table polish: sticky headers, right-aligned tabular numbers, calm hover; (21) landing third strip = Recent + Suggested (recency+frequency blend, localStorage, VERY pretty); (22) hover lift on landing cards; (23) Pull people big finish buttons (Save as list/Smart list/Campaign/Export); (25) icon consistency ONLY if clean; (26) sticky zone bar w/ blur. EXPLICITLY SKIPPED: 15 template unification. DO NOT restyle individual report layouts, especially Chad's Financial & SaaS Metrics report. | grep B23 docs/ledger/DOCKET.md | 2026-08-04 |
