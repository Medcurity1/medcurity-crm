...
6. **Verification over trust.** For any non-trivial change, spawn a verification subagent (the `verify-migration` agent in `.Codex/agents/`) that cross-references against the SF inventory.
