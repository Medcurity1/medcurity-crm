...
const CAPABILITIES: Capability[] = [
  ...
  { key: "manage_automations", label: "Configure Automations", category: "System" },
  { key: "manage_system", label: "System Settings", category: "System" },
  { key: "permanent_delete", label: "Permanent Delete", category: "System" },
...
function getDefaultPermissions(): PermissionsMap {
  return {
    view_accounts:         { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: true  },
    edit_accounts:         { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: false },
    archive_accounts:      { sales: false, renewals: false, admin: true,  super_admin: true,  read_only: false },
    view_contacts:         { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: true  },
    edit_contacts:         { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: false },
    view_leads:            { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: true  },
    edit_leads:            { sales: true,  renewals: false, admin: true,  super_admin: true,  read_only: false },
    convert_leads:         { sales: true,  renewals: false, admin: true,  super_admin: true,  read_only: false },
    view_opportunities:    { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: true  },
    edit_opportunities:    { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: false },
    view_pipeline:         { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: true  },
    view_renewals:         { sales: false, renewals: true,  admin: true,  super_admin: true,  read_only: true  },
    view_reports:          { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: true  },
    build_reports:         { sales: true,  renewals: true,  admin: true,  super_admin: true,  read_only: false },
    manage_custom_fields:  { sales: false, renewals: false, admin: true,  super_admin: true,  read_only: false },
    manage_users:          { sales: false, renewals: false, admin: true,  super_admin: true,  read_only: false },
    restore_archived:      { sales: false, renewals: false, admin: true,  super_admin: true,  read_only: false },
    manage_automations:    { sales: false, renewals: false, admin: false, super_admin: true,  read_only: false },
    manage_system:         { sales: false, renewals: false, admin: false, super_admin: true,  read_only: false },
    permanent_delete:      { sales: false, renewals: false, admin: false, super_admin: true,  read_only: false },
    manage_integrations:   { sales: false, renewals: false, admin: false, super_admin: true,  read_only: false },
  };
}
