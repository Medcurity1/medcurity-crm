...
function getDefaultPermissions(): PermissionsMap {
  return {
    view_accounts:         { sales: true,  renewals: true,  admin: true,  super_admin: true },
    edit_accounts:         { sales: true,  renewals: true,  admin: true,  super_admin: true },
    archive_accounts:      { sales: false, renewals: false, admin: true,  super_admin: true },
    view_contacts:         { sales: true,  renewals: true,  admin: true,  super_admin: true },
    edit_contacts:         { sales: true,  renewals: true,  admin: true,  super_admin: true },
    view_leads:            { sales: true,  renewals: true,  admin: true,  super_admin: true },
    edit_leads:            { sales: true,  renewals: false, admin: true,  super_admin: true },
    convert_leads:         { sales: true,  renewals: false, admin: true,  super_admin: true },
    view_opportunities:    { sales: true,  renewals: true,  admin: true,  super_admin: true },
    edit_opportunities:    { sales: true,  renewals: true,  admin: true,  super_admin: true },
    view_pipeline:         { sales: true,  renewals: true,  admin: true,  super_admin: true },
    view_renewals:         { sales: false, renewals: true,  admin: true,  super_admin: true },
    view_reports:          { sales: true,  renewals: true,  admin: true,  super_admin: true },
    build_reports:         { sales: true,  renewals: true,  admin: true,  super_admin: true },
    manage_custom_fields:  { sales: false, renewals: false, admin: true,  super_admin: true },
    manage_users:          { sales: false, renewals: false, admin: true,  super_admin: true },
    restore_archived:      { sales: false, renewals: false, admin: true,  super_admin: true },
    manage_automations:    { sales: false, renewals: false, admin: false, super_admin: true },
    manage_system:         { sales: false, renewals: false, admin: false, super_admin: true },
    permanent_delete:      { sales: false, renewals: false, admin: false, super_admin: true },
    manage_integrations:   { sales: false, renewals: false, admin: false, super_admin: true },
  };
}
