    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="camp-scope camp-shell w-[96vw] max-w-[96vw] sm:max-w-6xl h-[92vh] flex flex-col gap-0 overflow-hidden p-0">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-5 sm:px-6 py-5 space-y-6">
          ...
          {touchStatsQ.isError && (
            <QueryError message="Couldn't load per-email performance." onRetry={() => touchStatsQ.refetch()} />
          )}
          ...
          {/* Influence (outside-review I30) — deals opened on enrolled
              ...
              honestly support. */}
          {influenceQ.isError && (
            <QueryError message="Couldn't load campaign influence." onRetry={() => influenceQ.refetch()} />
          )}
