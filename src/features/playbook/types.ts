...
// campaign_suggestions (20260723020000) — AI-proposed template edits
// generated by playbook-ai's campaign-insights action (Campaigns overhaul
// Phase 4). See InsightsPanel.tsx.
export type SuggestionKind = "subject" | "body" | "timing" | "audience" | "general";
...
export interface CampaignSuggestion {
  ...
  /** Joined for display — see useCampaignSuggestions in api.ts. */
