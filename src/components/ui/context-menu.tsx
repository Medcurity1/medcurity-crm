...
// Slim shadcn-style wrapper over Radix ContextMenu (right-click menus).
// Only the pieces we use; extend as needed. Styling mirrors
// dropdown-menu.tsx so both menu kinds look identical.
